/** @file StandardHashTable.h */
//////////////////////////////////////////////////////////////////////////////
//                                                                          //
// File name : StandardHashTable.h
//
// Creation : 2004/12/21
//
// Version : 2004/12/21
...
// Author : JOL
//
// Summary : Header file for files StandardHashTable.ih and StandardHashTable.cxx
//
// History :
...
#if defined(StandardHashTable_RECURSES)
#error Recursive header files inclusion detected in StandardHashTable.h
#else // defined(StandardHashTable_RECURSES)
#define StandardHashTable_RECURSES

#if !defined StandardHashTable_h
#define StandardHashTable_h
...
namespace ImaGene 
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  /** 
   * Description of class 'StandardHashTable' <p> Aim: To represent a
  ...
  private:
     ...
     */
    StandardHashTableEntry* m_entries;
  ...
  private:
     ...
     */
    INLINE StandardHashTable( const StandardHashTable & other );
     ...
     * Forbidden by default.
     */
    INLINE StandardHashTable & operator=( const StandardHashTable & other );
...
#endif // !defined StandardHashTable_h

#undef StandardHashTable_RECURSES
#endif // else defined(StandardHashTable_RECURSES)
